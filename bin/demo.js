...
Main.main = function() {
					...
					return [fancy_table_util_CellContentImpl.LazyElement(function(_,_1,_2) {
						...
						if(null != attrs1) {
							...
							while(attr2.hasNext()) {
								...
								el2.setAttribute(attr3,__map_reserved[attr3] != null ? attrs1.getReserved(attr3) : attrs1.h[attr3]);
							}
						}
						var doc2 = null;
						if(null == doc2) {
						...
						if(null != attrs2) {
							...
							while(attr4.hasNext()) {
								...
								el3.setAttribute(attr5,__map_reserved[attr5] != null ? attrs2.getReserved(attr5) : attrs2.h[attr5]);
							}
						}
						var children1 = null;
						if(null != children1) {
						...
						if(null != attrs3) {
							...
							while(attr6.hasNext()) {
								...
								el4.setAttribute(attr7,__map_reserved[attr7] != null ? attrs3.getReserved(attr7) : attrs3.h[attr7]);
							}
						}
						var doc4 = null;
						if(null == doc4) {
						...
						if(null != attrs4) {
							...
							while(attr8.hasNext()) {
								...
								el5.setAttribute(attr9,__map_reserved[attr9] != null ? attrs4.getReserved(attr9) : attrs4.h[attr9]);
							}
						}
						var children3 = null;
						if(null != children3) {
	...
	var table = new fancy_Table(el,fancy_FancyTableData.Nested(toRowData(cards)),{ fixedTop : 1, fixedLeft : 1});
};
Math.__name__ = true;
var Std = function() { };
Std.__name__ = true;
...
var fancy_table_FancyTableSettings = function(fixedTop,fixedLeft,fallbackCell,classes,hSize,initialX,initialY,onScroll,onResize) {
...
fancy_table_FancyTableSettings.fromOptions = function(opts) {
	...
	return new fancy_table_FancyTableSettings(t != null ? t : 0,t1 != null ? t1 : 0,tmp,tmp1,t3 != null ? t3 : function(_,_2) {
		return fancy_CellDimension.RenderSmart;
	},t4 != null ? t4 : fancy_HorizontalScrollPosition.Left,t5 != null ? t5 : fancy_VerticalScrollPosition.Top,t6 != null ? t6 : function(_3,_4,_5,_6) {
	},t7 != null ? t7 : function(_7,_8,_9,_10) {
	});
};
